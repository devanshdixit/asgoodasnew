    ...
    <>
      <div className="container mt-4 pt-4 mb-4 pb-4" id="about">
        ...
        <div className="container mt-4 pt-4">
          <p className={styles.para}><strong>Hey! We’re As Good As New and we’re here to make your life more sustainable, Eco-Friendly and Pocket Friendly!
            You must be wondering “how’s that possible?” Well then we present to you a large community of thrift stores handpicked from India!</strong>
          </p>
      ...
      <div className="container mt-4 pt-4 mb-4 pb-4" id="about">
        ...
        <div className="container mt-4 pt-4">
          <p className={styles.para}>
            <strong>
              We provide the best, handpicked, locally sourced clothing items, accessories, footwear, jewellery, handicrafts.
              You name it and you’ll find a store selling that product on our website. Isn’t that just so convenient?
            </strong>
          </p>
        </div>
      </div>
      <div className="container mt-4 pt-4 mb-4 pb-4" id="about">
        <h1 className={styles.header}>Handpicked for You!</h1>
        <hr className={styles.hr} />
        <div className="container mt-4 pt-4">
          <p className={styles.para}>
            <strong>
