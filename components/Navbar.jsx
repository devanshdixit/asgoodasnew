...
const Header = () => {
    ...
    return (
        <Navbar collapseOnSelect expand="lg" bg="white" variant="light">
            <Container>
                <Navbar.Brand href="/"><h1 style={{fontWeight:"750",marginTop:"10px",marginLeft:"20px"}}>As Good As New.</h1></Navbar.Brand>
                <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="me-auto">
                    </Nav>
                    <Nav className="ml-auto">
                        <Nav.Link  className={styles.headerlink} style={{ paddingLeft: ".8em" }}>About</Nav.Link>
                        <Nav.Link  className={styles.headerlink} style={{ paddingLeft: ".8em" }}>Services</Nav.Link>
                        <Nav.Link  className={styles.headerlink} style={{ paddingLeft: ".8em" }}>ContactUs</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
